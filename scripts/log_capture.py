...
power_pattern.c, capture_buffer.c and include/tenstorrent/smc_msg.h):
  ...
  TT_SMC_MSG_CHARACTERISATION (0xC6) submessages (IDs after 19.13 kernel-throttler):
    0x4  TT_SUB_MSG_START_CLOCK_COUNTER     payload: delay_ms, on_go_busy, dur_ms
    0x5  TT_SUB_MSG_STOP_CLOCK_COUNTER
    0x6  TT_SUB_MSG_GET_CLOCK_PATTERN_INFO  -> VMA, capacity, evt_bytes, divisor,
                                              magic 0x02636c70 (v2 packs the
                                              dominant arb_max throttler ID
                                              into bits 12..15 of mhz),
                                              data[6] = (avg_mhz<<16)|fill_idx,
                                              data[7] = ring_wrapped
    0x7  TT_SUB_MSG_START_POWER_COUNTER     payload: delay_ms, on_go_busy, dur_ms
    0x8  TT_SUB_MSG_STOP_POWER_COUNTER
    0x9  TT_SUB_MSG_GET_POWER_PATTERN_INFO  -> VMA, capacity, 2,
                                              divisor, magic 0x01727770,
                                              fill_idx, ring_wrapped

power_pattern[] stores telemetry.vcore_power (VCORE) in centiwatts.
...
SUB_START_CLOCK = 0x4
SUB_STOP_CLOCK = 0x5
SUB_GET_CLOCK_INFO = 0x6
SUB_START_POWER = 0x7
SUB_STOP_POWER = 0x8
SUB_GET_POWER_INFO = 0x9
